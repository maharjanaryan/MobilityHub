                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 rounded-lg px-3 py-2 focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none"
                    />
                  </div>
                  <div>
                  ...
                  <div className="flex gap-3 pt-4">
                    <button
                      ...
                      className="flex-1 bg-emerald-600 dark:bg-emerald-500 text-white py-2 rounded-lg hover:bg-emerald-700 dark:hover:bg-emerald-600 disabled:opacity-50"
                    >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4">
                    <button
                      ...
                      className="flex-1 bg-emerald-600 dark:bg-emerald-500 text-white py-2 rounded-lg hover:bg-emerald-700 dark:hover:bg-emerald-600"
                    >
                      Edit User
                    </button>
                    <button
