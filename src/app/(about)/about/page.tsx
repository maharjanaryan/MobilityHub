...
export default function AboutPage() {
  return (
    <main className="bg-white dark:bg-gray-950 transition-colors duration-300">
      ...
      {/* Mission & Vision */}
      <div className="bg-green-50/30 dark:bg-green-950/20 py-24 sm:py-32 transition-colors duration-300">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-3">
              {[
                ...
                <div key={v.title} className="flex flex-col items-start">
                  <div className="rounded-lg bg-white dark:bg-gray-900/50 p-6 shadow-md ring-1 ring-gray-900/5 dark:ring-gray-800 transition-all duration-300 hover:shadow-lg hover:ring-green-500/20 dark:hover:ring-green-500/30">
      ...
      {/* Team */}
      <div className="bg-gray-50 dark:bg-gray-900/50 py-24 sm:py-32 transition-colors duration-300">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-green-600 dark:text-green-400">
              The people behind Mobily Hub
            </h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            {teamMembers.map((member) => (
              <div key={member.name} className="flex flex-col items-start group">
                <div className="relative aspect-[3/2] w-full overflow-hidden rounded-2xl bg-gray-100 dark:bg-gray-800 transition-transform duration-300 group-hover:scale-[1.02]">
                  <Image
                    src={member.imageUrl}
                    alt={member.name}
                    fill
                ...
                <p className="text-base leading-7 text-green-600 dark:text-green-400">
                  {member.role}
                </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                href="/vehicles"
                className="rounded-md bg-green-700 dark:bg-green-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-600 dark:hover:bg-green-500 transition-colors duration-300"
              >
                Find a vehicle
              </Link>
              <Link
                href="/contact"
                className="rounded-md bg-gray-400/30 dark:bg-gray-700/50 px-3.5 py-2.5 text-sm font-semibold text-gray-900 dark:text-white backdrop-blur-sm hover:bg-gray-400/40 dark:hover:bg-gray-700/70 transition-colors duration-300"
              >
                Contact support
              </Link>
            </div>
